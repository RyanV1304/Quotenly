...
export const metadata: Metadata = {
  ...
  description: "The terms that govern your use of Krewbill.",
};
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-16">
        ...
        <div className="mt-10 flex flex-col gap-8 text-sm leading-relaxed text-ink-soft">
          <section>
            ...
            <p className="mt-2">
              By creating an account or using Krewbill (&quot;the Service,&quot; &quot;we,&quot; &quot;us&quot;),
              you agree to these Terms of Service. If you don&apos;t agree, don&apos;t use Krewbill.
            </p>
          </section>

          <section>
            <h2 className="font-display text-lg font-bold text-ink">2. What Krewbill Is</h2>
            <p className="mt-2">
              Krewbill is quoting and invoicing software for small businesses. You use it to create quotes, send
          ...
          <section>
            ...
            <p className="mt-2 italic text-ink-faint">
              This section is pending finalization with legal counsel and will be added once Krewbill&apos;s
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5">
              ...
              <li>You must be at least 18 years old to use Krewbill.</li>
              <li>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5">
              <li>Use Krewbill for any illegal purpose, or to send fraudulent quotes or invoices</li>
          ...
          <section>
            ...
            <p className="mt-2">
              When you add a client&apos;s name, email, or address to Krewbill, you&apos;re entering another
              person&apos;s personal information into our system on their behalf. You confirm you have the right to
              store and share this information with them via Krewbill (e.g., sending them a quote link) and that
          ...
          <section>
            ...
            <p className="mt-2">
              Krewbill generates shareable links so your clients can view and approve quotes or view invoices without
          ...
          <section>
            ...
            <p className="mt-2">
              When a client approves a quote through Krewbill, they do so by drawing a signature that is stored as
              part of the record. This is intended to reflect a genuine agreement between you and your client.
              Krewbill is not a party to that agreement and is not responsible for disputes arising from it.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              During the current phase of service, Krewbill does not process payments. Any payment instructions you
          ...
          <section>
            ...
            <p className="mt-2">Not applicable — Krewbill is currently free of charge.</p>
          </section>

          <section>
            <h2 className="font-display text-lg font-bold text-ink">12. Pricing</h2>
            <p className="mt-2">
              Krewbill is currently provided free of charge. We reserve the right to introduce paid plans in the
          ...
          <section>
            ...
            <ul className="mt-2 list-disc pl-5">
              <li>You may stop using Krewbill and delete your account at any time.</li>
              <li>
              ...
              <li>
                ...
                termination; Krewbill is not a party to those obligations.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              Krewbill is provided &quot;as is.&quot; We do not guarantee the Service will be uninterrupted,
          ...
          <section>
            ...
            <p className="mt-2">
              To the fullest extent permitted by law, Krewbill&apos;s total liability to you for any claim arising
          ...
          <section>
            ...
            <p className="mt-2">
              You agree to defend and hold Krewbill harmless from any claims arising from your use of the Service,
          ...
          <section>
            ...
            <p className="mt-2">
              We may update these Terms from time to time. Continued use of Krewbill after changes take effect
